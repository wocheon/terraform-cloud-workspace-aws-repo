...
module "eip_associate" {  
  ...
  version = "1.0.1"  
  aws_eip_associate_instance_id = moudle.ec2_instance.instance_id
  aws_eip_associate_allocation_id = var.aws_eip_associate_allocation_id != "" ? var.aws_eip_associate_allocation_id : module.eip[0].allocation_id
}